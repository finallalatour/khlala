...
CREATE TABLE PRODUCT(
   ...
   TNAME VARCHAR2(50) NOT NULL,
   PPOINT NUMBER(10) NOT NULL,
   HCOUNT NUMBER(10) NOT NULL
)
...
CREATE TABLE CART(
   ...
   OSEQ NUMBER(8) NOT NULL,
   GSEQ NUMBER(8) NOT NULL
);
...
REFERENCES PRODUCT(RRODUCT_SEQ);
...
CREATE TABLE ORDERED (
	ORDERED_SEQ NUMBER(8) PRIMARY KEY,
...
CREATE TABLE GOODS(
    GOODS_SEQ NUMBER(8) PRIMARY KEY,
    GPSEQ NUMBER(8) NOT NULL,
    GOSEP NUMBER(8) NOT NULL,
...
ALTER TABLE GOODS
ADD CONSTRAINT FK_GOODS_ID FOREIGN KEY(GID)
REFERENCES MEMBER(ID);

ALTER TABLE GOODS
ADD CONSTRAINT FK_GOODS_GPSEQ FOREIGN KEY(GPSEQ)
REFERENCES PRODUCT(PRODUCT_SEQ);

ALTER TABLE GOODS
ADD CONSTRAINT FK_GOODS_GOSEQ FOREIGN KEY(GOSEP)
REFERENCES ORDERED(ORDERED_SEQ)
